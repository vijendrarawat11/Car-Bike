...
namespace Cars_Bikes.Migrations
{
    ...
    [Migration("20240607113813_AddTWbrand")]
    partial class AddTWbrand
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cars_Bikes.Models.TwoWheeler", b =>
                {
                    ...
                    b.Property<int>("TwoWheelerBrandTWBrandId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TwoWheelerBrandTWBrandId");
            ...
            modelBuilder.Entity("Cars_Bikes.Models.TwoWheeler", b =>
                {
                    b.HasOne("Cars_Bikes.Models.TwoWheelerBrand", "TwoWheelerBrand")
                        .WithMany()
                        .HasForeignKey("TwoWheelerBrandTWBrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("TwoWheelerBrand");
                });
