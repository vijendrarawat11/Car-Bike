        ...
        resetVideo: function(e, o, d) {
            ...
            switch (n.videotype) {
                ...
                case "html5":
                    ...
                    } catch (e) {}("mute" == n.volume || a.lastToggleState(e.videomutetoggledby) || !0 === o.globalmute) && (u.muted = !0)
            }
        },
        ...
        checkVideoApis: function(e, t, a) {
            ...
            if ((void 0 != e.data("vimeoid") || e.find("iframe").length > 0 && e.find("iframe").attr("src").toLowerCase().indexOf("vimeo") > 0) && (t.vimeoapineeded = !0), (void 0 != e.data("vimeoid") || e.find("iframe").length > 0 && e.find("iframe").attr("src").toLowerCase().indexOf("vimeo") > 0) && 0 == a.addedvim) {
                ...
                n.src = "https://secure-a.vimeocdn.com/js/froogaloop2.min.js", jQuery("head").find("*").each(function() {
                    "https://secure-a.vimeocdn.com/js/froogaloop2.min.js" == jQuery(this).attr("src") && (d = !1)
            ...
            switch (k = !0 === p.nextslideatend ? "" : k, p.videotype = x, V) {
                ...
                case "youtube":
                    ...
                    var j = t(e.data("videostartat")),
                        _ = t(e.data("videoendat")); - 1 != j && (v = v + "&start=" + j), -1 != _ && (v = v + "&end=" + _);
                        ...
                        events: {
                            onStateChange: function(i) {
                                ...
                                if (i.data == YT.PlayerState.PLAYING) punchgs.TweenLite.to(e.find(".tp-videoposter"), .3, {
                                    ...
                                    display: "block",
                                    ease: punchgs.Power3.easeInOut
                                }), "mute" == e.data("volume") || a.lastToggleState(e.data("videomutetoggledby")) || !0 === o.globalmute ? k.mute() : (k.unMute(), k.setVolume(parseInt(e.data("volume"), 0) || 75)), o.videoplaying = !0, p(e, o), m ? o.c.trigger("stoptimer") : o.videoplaying = !1, o.c.trigger("revolution.slide.onvideoplay", n(k, "youtube", e.data())), a.toggleState(r.videotoggledby);
                                else {
                                    if (0 == i.data && g) {
                                        var c = t(e.data("videostartat")); - 1 != c && k.seekTo(c), k.playVideo(), a.toggleState(r.videotoggledby)
                                    }
        ...
        u = function(e, o, r) {
            ...
            void 0 != w && d(w, "click", function() {
                ...
                if (void 0 != x && (x.value = a), 0 != i && -1 != i && Math.abs(i - d) <= .3 && i > d && 1 != e.data("nextslidecalled"))
                    if (y) {
                        m.play();
                        var n = t(e.data("videostartat")); - 1 != n && (m.currentTime = n)
